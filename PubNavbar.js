  ...
  return (
    <div>
      <Navbar bg="primary" text="white" expand="lg">
                <Navbar.Brand style={{ color: "white" }}>H&k hospital</Navbar.Brand>
                <Navbar.Toggle />
                <Container>
                    ...
                    <Nav.Link className="text-white" href="/">Home</Nav.Link>
                        ...
                        <Nav.Link className="text-white" href="/doctorRegister">Doctor Register</Nav.Link>
                    </Nav>
                        <Nav className="justify-content-end mr-20">
                            <NavDropdown title="Login" className="me-auto" id="basic-nav-dropdown">
                                ...
                                <NavDropdown.Item href="/login/DoctorLogin">Doctor Login</NavDropdown.Item>
